 ...
 * 
 * @ClassName: PHash 
 * @Description: 优化前的PHash算法。已废弃，留备参考
 * @author HuDaoquan
 * @date 2019年7月1日 下午9:31:32 
 * @version v1.0
 */
public class PHash {

	public static void main(String[] args) {
		String str1 = "D:\\我的文档\\桌面\\bb.png";
		String str2 = "D:\\我的文档\\桌面\\aa.png";
		PHash P = new PHash();
		System.out.println(P.getSimilarity(str1, str2));
	}
	...
	public double getSimilarity(String str1, String str2) {
		String hash1 = getFeatureValue(str1);

		String hash2 = getFeatureValue(str2);
